...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '一个数分人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://XXX.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客,数分', // 网站关键词 英文逗号隔开
