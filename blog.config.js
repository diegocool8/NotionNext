...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '从事数据分析的INFJ、读书_运动_音乐让人快乐', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.wangduoduo.top/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '读书,运动,看世界,INFJ,数分', // 网站关键词 英文逗号隔开
