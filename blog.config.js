...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Diego', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个沪漂数分人、INFJ、爱理想爱自由', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.fanmaimeihaoshenghuo.top/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '自由，INFJ, 博客,数分', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个自由的人, ,Hi，我是一个INFJ,欢迎来到我的博客🎉',
